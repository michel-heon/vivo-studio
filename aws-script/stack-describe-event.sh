...
aws cloudformation describe-stack-events --stack-name $STACK_NAME_ID --query "sort_by(StackEvents, &Timestamp)[].[Timestamp,LogicalResourceId,ResourceStatus]" --output=text | tee
